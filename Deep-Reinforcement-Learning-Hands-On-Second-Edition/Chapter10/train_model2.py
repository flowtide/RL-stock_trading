...
stock_data = {"YNDX": data.load_relative(data_path, filter_data=False)}
env = environ.StocksEnv(stock_data, bars_count=BARS_COUNT, state_1d=state_1d, commission=args.commission)
env_tst = environ.StocksEnv(stock_data, bars_count=BARS_COUNT, state_1d=state_1d, commission=args.commission)

env = gym.wrappers.TimeLimit(env, max_episode_steps=1000)
val_data = {"YNDX": data.load_relative(val_path, filter_data=False)}
env_val = environ.StocksEnv(val_data, bars_count=BARS_COUNT, state_1d=state_1d, commission=args.commission)
